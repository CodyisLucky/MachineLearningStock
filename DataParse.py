...
def Key_Stats(gather="Total Debt/Equity (mrq)"):
	...
	for each_dir in stock_list[1:25]: #stocks 1 to all
		...
		if len(each_file) > 0: #makes sure there is data
			for file in each_file:
				...
				try:
					try:
						value = float(source.split(gather+':</td><td class="yfnc_tabledata1">')[1].split('</td>')[0]) #splits source code to the Debt/Equity value
